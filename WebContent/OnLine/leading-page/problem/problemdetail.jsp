...
<head>
    ...
    <link rel="stylesheet" href="../../css/problem/problemdetail.css" />
    ...
    <script type="text/javascript" src="../../js/problem/problemdetail.js"></script>
</head>
<body>
<div class="ui fixed inverted menu">
    ...
    <a href="../problem/problemset.html" class="active item">
...
<div class="ui header container">
    <div class="ui large breadcrumb">
        ...
        <a class="section" href="../problem/problemset.html">题库中心</a>
        <i class="right chevron icon divider"></i>
        <a class="section" href="problemlist.html" text="${data['subject'].name}">数据结构与算法</a>
        <i class="right chevron icon divider"></i>
        <div class="active section" text="${data['question'].title}">某保险公司多年的资料表明，在索赔户中，被盗索赔户占20%，以 表示在随机抽查100个索赔户中因被盗而向保险公司索赔的户数，求 . x 0 0.5 1 1.5 2 2.5 3 Ф (x) 0.500 0.691 0.841 0.933 0.977 0.994 0.999</div>
    </div>
</div>
        ...
        <div class="ten wide column">
            <div class="row">
                <div class="ui stacked segment">
                    ...
                    <p style="font-size: 16px;" text="${data['question'].content}">某保险公司多年的资料表明，在索赔户中，被盗索赔户占20%，以 表示在随机抽查100个索赔户中因被盗而向保险公司索赔的户数，求 . x 0 0.5 1 1.5 2 2.5 3 Ф (x) 0.500 0.691 0.841 0.933 0.977 0.994 0.999</p>
                </div>
            </div>
            <!-- 选择题 -->
            <div if="${data['question'].questionType == 0 or data['question'].questionType == 1}" class="row" style="margin-top: 1em;">
                <div class="ui segment"><h4 class="ui horizontal divider header"><i class="hashtag icon"></i>题目选项</h4>
                    <div text="'A.'+${data['question'].optionA}" class="row" style="font-size: 16px;">A. 作业流</div>
                    <div text="'B.'+${data['question'].optionB}" class="row" style="font-size: 16px;">B. 子程序</div>
                    <div text="'C.'+${data['question'].optionC}" class="row" style="font-size: 16px;">C. 子进程</div>
                    <div text="'D.'+${data['question'].optionD}" class="row" style="font-size: 16px;">D. 作业步</div>
                </div>
            </div>
            <div if="${data['question'].questionType == 0 or data['question'].questionType == 1}" class="row" style="margin-top: 1em;">
                <!-- 显示与隐藏 ，需要自己js控制-->
                <div class="ui accordion segment active">
                    <div class="title active"><i class="dropdown icon"></i>查看正确答案</div>
                    <div class="content ui segment active">
                        <h4 class="ui dividing header">正确答案:<span text="${data['question'].answer}">A</span></h4>
                        <h4 class="ui dividing header">答案解析:</h4>
                        <p style="font-size: 16px;font-weight: bold;" text="${data['question'].parse}">
        ...
        <div class="four wide column">
            <table class="ui table">
                ...
                <tr>
                    ...
                    <td>
                        <span if="${data['question'].questionType == 0}">单选题</span>
